...
print("თქვენ შეიყვანეთ მონაცემი: {user_input}")
print("მონაცემის ტიპი არის: {type(user_input)}")
...
# გატესტეთ ეს კოდი პითონში:  დააკვირდით რა შედეგს გამოიტანს და ივარაუდეთ რატომ ქნა ასე
print(10 < 1)
